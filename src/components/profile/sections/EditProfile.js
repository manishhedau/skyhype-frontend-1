...
export default function EditProfile() {
    ...
    return (
        <>
            <Model isVisible={isVisible} toggleVisible={toggleVisible} />
            <Card>
                <form action="" className="form" onSubmit={handleSubmit}>
                    <div className="form__row">
                        <div className="form__first__row">
                            <div className="imageContainer">
                                <Image src={editprofile.profile_image || Avtar} alt="person" sx={{ width: "5rem", height: "5rem" }} />
                                <div className="plus_icon" onClick={toggleVisible}><i class="fas fa-pen"></i></div>
                            </div>
