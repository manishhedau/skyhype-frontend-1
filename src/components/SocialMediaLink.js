...
function SocialMediaLink({ icon, socialLink, onLinkChange, onIsActive, onTrashButton, placeholder }) {
    const { isActive, link, social_media } = socialLink;
    ...
    return (
        <div className="social_link">
            <div className="social_container">
                ...
                <img src={icon} alt={social_media} class="social-icon" />

                <input type="text" className="social_link_input" value={link} placeholder={placeholder} onChange={handleChange} />
