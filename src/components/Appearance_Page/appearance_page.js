...
const AppearancePage = () => {
    ...
    const getUserStyles = async () => {
        ...
        const userStyles = await axios.get(`/dashboard/${userID}`);
    ...
    const handleFont = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8080/dashboard/styles/${userID}`, { styles: { background: background, font } })
    ...
    const handleBackground = async (e) => {
        ...
        try {
            ...
            console.log(dataToSend);
            let result = await axios.put(`http://localhost:8080/dashboard/styles/${userID}`, { styles: { background, font } })
